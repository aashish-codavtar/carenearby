...
const T = {
  ...
  fr: {
    ...
    onlineSub: 'En ligne · Accepte des demandes',
    offlineSub: 'Aller en ligne pour accepter des emplois',
    onlineLabel: 'EN LIGNE',
    goOnline: 'DÉMARRER',
    tapOffline: 'Appuyer pour\ndésactiver',
    tapStart: 'Appuyer pour\ncommencer',
    today: "Aujourd'hui",
...
const styles = StyleSheet.create({
  ...
  onlineBtn: {
    ...
    overflow: 'hidden',
    shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.4, shadowRadius: 20, elevation: 14,
  },
  onlineBtnOn: { backgroundColor: '#fff' },
  onlineBtnOff: { backgroundColor: 'rgba(255,255,255,0.12)', borderWidth: 2.5, borderColor: 'rgba(255,255,255,0.4)' },
  onlineBtnIcon: { fontSize: 32, marginBottom: 6 },
  onlineBtnText: { fontSize: 15, fontWeight: '900', textAlign: 'center', letterSpacing: 0.5 },
  onlineBtnSub: { fontSize: 10, marginTop: 3, textAlign: 'center', lineHeight: 14 },
