...
const T = {
  en: {
    ...
    nearbySub:      'Verified PSWs ready in Greater Sudbury',
    viewMap:        '🗺 View on map',
    quickLabel:     'Quick',
  ...
  fr: {
    ...
    availableToday: "DISPONIBLE MAINTENANT",
    bookNow:        'Réserver maintenant',
    bookSub:        "Disponible aujourd'hui · À partir de 25 $/h",
    nearbyTitle:    'PAP à proximité',
    nearbySub:      'PAP vérifiés disponibles à Sudbury',
...
const styles = StyleSheet.create({
  ...
  bookingCardEyebrow:   { color: 'rgba(255,255,255,0.55)', fontSize: 10, fontWeight: '700', letterSpacing: 0.8, marginBottom: 4 },
